...
export function activate(context: vscode.ExtensionContext) {
  ...
  vscode.commands.registerCommand('logpack.showList', () => { logPackProvider.showList() })
  vscode.commands.registerCommand('logpack.groupByReturnCode', () => { logPackProvider.groupByReturnCode() })
  vscode.commands.registerCommand('logpack.groupByDate', () => { logPackProvider.groupByDate() })
